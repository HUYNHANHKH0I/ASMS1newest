...
public class ManageAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView accountListView = (ListView)findViewById(R.id.listAccountManageAccount);
    ...
    public void clickToSearchAccount(View view) {
        String searchValue = ((EditText) (findViewById(R.id.edtSearchAccountManageAccount))).getText().toString();
